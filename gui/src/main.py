...
class CustomItems:
    ...
    def new_button(self, text: str, function_button) -> tk.Button:
        button = tk.Button(self.window, text=text, function=function_button)
        button.pack()
        return button
...
class Menu:
    ...
    def loop(self):
        ...
        self.mi.load_icon("gui/assets/icon/fe.png")
